...
FROM registry.access.redhat.com/rhel8/nodejs-14 AS packages
...
FROM registry.access.redhat.com/rhel8/nodejs-14 AS build
...
FROM registry.access.redhat.com/rhel8/nodejs-14
